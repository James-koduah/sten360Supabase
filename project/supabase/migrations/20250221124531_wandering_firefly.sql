/*
  ...
  1. Changes
    - Modify order number generation to include organization prefix
    - Reset sequence per organization and month
    - Format: ORG-YYYYMM-XXXXX

  2. Details
    - Get organization name prefix from first letters
    - Include year and month in order number
    - Start counting from 10000 for each org/month
*/
...
BEGIN
  ...
  -- Format order number: ORG-YYYYMM-XXXXX
