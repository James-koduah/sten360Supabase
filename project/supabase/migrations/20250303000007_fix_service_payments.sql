-- Drop the existing service_payments table
DROP TABLE IF EXISTS service_payments;

-- Recreate the service_payments table without the recorded_by field
...
-- Update the record_payment function to not use recorded_by for service payments
